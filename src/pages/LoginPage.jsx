  ...
  async function handleSignIn() {
    try {
      ...
      if (error.message && error.message.includes('Unauthorized')) {
        setError('Your account is not authorized to access this application. Please contact an administrator.')
          ...
          {error && (
            <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-md text-left">
              <div className="flex items-start">
                <svg className="h-5 w-5 text-red-400 mt-0.5 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
