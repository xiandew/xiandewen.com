...
export default function TreatmentForm({ initialData, onSave, onCancel, onDelete }) {
  ...
  const [modalData, setModalData] = useState({ treatment: '', chargedPrice: '', quotePrice: '', note: '' })
      ...
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-6 sm:gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-1 sm:col-span-3">
              <label htmlFor="contact" className="block text-sm/6 font-medium text-gray-900">Contact</label>
              <div className="mt-2">
                <input
                  id="contact"
                  name="contact"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl p-4 sm:p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="modal-treatment" className="block text-sm/6 font-medium text-gray-900">Treatment</label>
                <div className="mt-2">
                  <input
                    id="modal-treatment"
                    type="text"
              ...
              <div>
                <label htmlFor="modal-note" className="block text-sm/6 font-medium text-gray-900">Note</label>
                <div className="mt-2">
                  <textarea
                    id="modal-note"
                    rows={3}
          ...
          <div className="bg-white rounded-lg shadow-xl p-4 sm:p-6 max-w-md w-full">
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  This will mark the customer and all treatment records as deleted. The data will be soft-deleted and can be recovered by administrators.
                </p>
              </div>
            </div>
