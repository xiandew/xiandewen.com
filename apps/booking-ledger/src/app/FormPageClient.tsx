...
export default function FormPage({ mode }: FormPageProps) {
  const router = useRouter()
  const searchParams = useSearchParams()
  const itemId = searchParams.get("id")
  const [editingItem, setEditingItem] = useState<Treatment | undefined>(undefined)
  ...
  async function handleSave(data: Omit<Treatment, "id">) {
    try {
      showLoading()
      if (editingItem) {
