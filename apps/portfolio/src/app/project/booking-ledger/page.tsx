            ...
            <div className="md:col-span-2 space-y-12">
                ...
                <section>
                    ...
                    <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                        ...
                        <li className="flex items-start">
                            <svg className="w-5 h-5 mr-3 text-blue-500 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                            <span>Real-time data synchronization with Firebase Firestore</span>
                        </li>
                        <li className="flex items-start">
                             <svg className="w-5 h-5 mr-3 text-blue-500 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                        ...
                        <li className="flex items-start">
                             <svg className="w-5 h-5 mr-3 text-blue-500 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                             <span>Treatment tracking with pricing and notes</span>
                        </li>
                        <li className="flex items-start">
                             <svg className="w-5 h-5 mr-3 text-blue-500 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                             <span>Soft delete functionality for data integrity</span>
                        </li>
                    </ul>
                </section>
            </div>
