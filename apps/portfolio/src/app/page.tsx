        ...
        <section id="work" className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
            ...
            <Link href="/project/pareidolia" className="group block col-span-1 md:col-span-2 lg:col-span-6">
              <div className="relative bg-white dark:bg-gray-900 rounded-3xl sm:rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 dark:border-white/10 transition-all duration-500 hover:shadow-xl hover:-translate-y-1 aspect-[16/10] md:aspect-[2/1] lg:aspect-[2.5/1]">
                ...
                <div className="absolute top-6 left-6 sm:top-8 sm:left-10 z-20">
                  <div className="text-left">
                    ...
                    <p className="text-base sm:text-lg text-gray-500 dark:text-gray-400 font-medium">AI Sketch Enhancement Tool</p>
                  </div>
                </div>

                {/* CSS Art: Pareidolia - Browser Window */}
                <div className="absolute inset-x-0 bottom-0 top-[30%] w-full flex justify-center px-6 sm:px-12 md:px-24">
                  <div className="w-full h-[120%] bg-white dark:bg-gray-950 rounded-t-xl border-2 border-gray-200 dark:border-gray-800 flex flex-col overflow-hidden shadow-2xl transition-transform duration-500 group-hover:-translate-y-2">
                    {/* Window Header */}
                    ...
                    <div className="flex-1 flex overflow-hidden bg-white dark:bg-gray-950 relative">
                      {/* Sidebar - Mini Tools */}
                      <div className="w-12 sm:w-14 border-r border-gray-100 dark:border-gray-800 flex flex-col items-center py-3 gap-3 bg-gray-50/50 dark:bg-gray-900/50 z-10">
                      ...
                      <div className="flex-1 flex flex-col relative w-full">
                        ...
                        <div className="h-10 border-b border-gray-100 dark:border-gray-800 flex items-center px-4 justify-between bg-white dark:bg-gray-900/80 z-10">
                          <div className="flex gap-2">
                            <div className="px-2 py-0.5 rounded-full bg-fuchsia-50 dark:bg-fuchsia-900/20 text-[9px] font-medium text-fuchsia-600 dark:text-fuchsia-300 border border-fuchsia-100 dark:border-fuchsia-800/50">House</div>
                        ...
                        {/* Workspace */}
                        <div className="flex-1 relative -translate-y-5 sm:-translate-y-10 bg-gray-50/30 dark:bg-black/20 flex flex-col items-center justify-center p-2">
                          {/* Dot Grid Background */}
                          ...
                          <div className="relative flex items-center gap-2 sm:gap-6 z-10 w-full justify-center">

                            {/* Left: Input Sketch */}
                            <div className="group/sketch relative size-20 sm:size-48 bg-white dark:bg-gray-900 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 shadow-sm flex items-center justify-center">
                              <div className="absolute top-1.5 left-2 text-[8px] text-gray-400 font-mono tracking-wider">INPUT</div>
                              <svg className="size-12 sm:size-24 text-gray-400 dark:text-gray-500 stroke-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <div className="flex flex-col items-center gap-1 opacity-80">
                              <div className="flex space-x-0.5">
                                <span className="w-1 h-1 rounded-full bg-fuchsia-400 animate-[bounce_1s_infinite_0ms]"></span>
                                <span className="w-1 h-1 rounded-full bg-fuchsia-500 animate-[bounce_1s_infinite_200ms]"></span>
                                <span className="w-1 h-1 rounded-full bg-fuchsia-600 animate-[bounce_1s_infinite_400ms]"></span>
                              </div>
                            </div>

                            {/* Right: AI Output */}
                            <div className="group/result relative size-20 sm:size-48 bg-white dark:bg-gray-900 rounded-xl border border-fuchsia-200 dark:border-fuchsia-900 shadow-xl shadow-fuchsia-500/15 flex items-center justify-center overflow-hidden">
                              ...
                              <div className="absolute top-1.5 left-2 text-[8px] text-fuchsia-600 dark:text-fuchsia-400 font-mono tracking-wider font-bold">RESULT</div>

                              <svg className="size-12 sm:size-28 text-fuchsia-600 dark:text-fuchsia-400 drop-shadow-sm transform transition-transform duration-500 group-hover/result:scale-105" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                              ...
                              <div className="absolute top-2 right-2 text-amber-400 animate-pulse">
                                <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3 7h7l-6 5 2 7-6-5-6 5 2-7-6-5h7z" /></svg>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <Link href="/project/booking-ledger" className="group block col-span-1 md:col-span-2 lg:col-span-2">
              <div className="relative bg-white dark:bg-gray-900 rounded-3xl sm:rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 dark:border-white/10 transition-all duration-500 hover:shadow-xl hover:-translate-y-1 aspect-[16/10] md:aspect-[16/9] lg:aspect-auto lg:h-full">
                ...
                <div className="absolute top-6 left-6 sm:top-8 sm:left-10 z-20">
                  <div className="text-left">
                      ...
                      <p className="text-base sm:text-lg text-gray-500 dark:text-gray-400 font-medium">Enterprise SaaS Platform</p>
                    </div>
                 </div>

                {/* CSS Art: Mobile/App Interface - Stacking Cards */}
                <div className="absolute inset-x-0 bottom-0 top-1/4 flex items-center justify-center pointer-events-none">
                  <div className="relative w-full h-full max-w-[280px]">
                    {/* Background List Card */}
                    <div className="absolute top-0 left-8 right-0 bottom-8 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 opacity-60 transform rotate-6 transition-transform duration-500 group-hover:rotate-12 group-hover:translate-x-4">
                    ...
                    <div className="absolute top-8 left-0 right-8 bottom-0 bg-white dark:bg-gray-900 rounded-2xl border-2 border-indigo-50 dark:border-indigo-900/30 shadow-2xl transition-transform duration-500 group-hover:-translate-y-2 group-hover:-rotate-3 overflow-hidden">
                      {/* Card Header */}
            ...
            <Link href="/project/booking-saas" className="group block col-span-1 md:col-span-2 lg:col-span-4">
              <div className="relative bg-white dark:bg-gray-900 rounded-3xl sm:rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 dark:border-white/10 transition-all duration-500 hover:shadow-xl hover:-translate-y-1 aspect-[16/10] md:aspect-[16/9]">
                ...
                <div className="absolute top-6 left-6 sm:top-8 sm:left-10 z-20">
                  <div className="text-left">
                    ...
                    <p className="text-base sm:text-lg text-gray-500 dark:text-gray-400 font-medium">Multi-tenant Architecture</p>
                  </div>
                </div>

                {/* CSS Art: Booking SaaS Dashboard */}
                <div className="absolute inset-0 flex justify-center pt-32 px-6 sm:px-12">
                      ...
                      <div className="flex-1 flex flex-col pt-2 relative">
                        ...
                        <div className="flex-1 relative overflow-hidden">
                          ...
                          {/* <div className="absolute inset-0 flex flex-col justify-evenly pointer-events-none">
                                         {[...Array(6)].map((_, i) => (
                                             <div key={i} className="border-b border-dashed border-gray-100 dark:border-gray-800 w-full h-full"></div>
                                         ))}
                                     </div> */}
